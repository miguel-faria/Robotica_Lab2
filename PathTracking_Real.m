...
while point_index ~= path_real_len
    ...
    robot_internal_error = 0.044747349 * robot_internal_error * scale_error + errors_robot(2);
...
%     end
    ...
    if t >= 0.1
        ...
        errors_world_map = [x_ref_map - x_map; y_ref_map - y_map; theta_ref_map - theta_map];
        ...
        x_map = x_map + 2*cos(theta_map)*2 + 2/75*2/50*random_val(1);
        y_map = y_map + 2*sin(theta_map)*2 + 2/75*random_val(2);    
